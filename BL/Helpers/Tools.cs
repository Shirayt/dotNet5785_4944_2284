...
internal static class Tools
{
    ...
    public static void SetDistanceType(BO.DistanceType distanceType)
    {
    ...
    /// <param name="longitudeC">The longitude of the second point.</param>
    /// <returns>The calculated distance in kilometers.</returns>
    public static async Task<double> CalculateDistanceAsync(BO.DistanceType type, double latitudeV, double longitudeV, double latitudeC, double longitudeC)
    {
        return type switch
        {
            BO.DistanceType.Air => CalculateDistance(latitudeV, longitudeV, latitudeC, longitudeC),
            BO.DistanceType.Walk => await GetRouteDistanceAsync(latitudeV, longitudeV, latitudeC, longitudeC, "pedestrian"),
            BO.DistanceType.Drive => await GetRouteDistanceAsync(latitudeV, longitudeV, latitudeC, longitudeC, "car"),
